...
$mbCompletePath = "D:\reports\DDBWW_Complete_Mailboxes.csv"
$gaReportPath = "D:\reports\DDBWW_Global_Admins.csv"
        
$LicenseUserInfo | Export-Csv -Path $mbCompletePath -NoTypeInformation
$_globalAdmins | Export-Csv -Path $gaReportPath -NoTypeInformation


$outfile = "D:\reports\DDBWW_O365_Complete_$($date).xlsx"

ConvertAppendCSVXLSX -inputfile @($gaReportPath, $mbCompletePath) -outfile $outfile
...
$subject= "DDBWW Complete Office 365 Report"
$body= "
    <h1>DDB Worldwide Complete Office 365 Report</h1>
    <p>Attached you will find an Excel report that contains MFA, licensing, mailbox forwarding rules and more for DDB Worldwide Office 365 tenants including:</p>
    <br/>
    <ul>
        $_officeLocations
    </ul>
